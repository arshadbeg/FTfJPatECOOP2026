...
/*@
  requires \valid_read(x63 + (0 .. x64*x65 - 1));
  requires \valid_read(x66 + (0 .. x67*x68 - 1));
  requires \valid(x69 + (0 .. x70*x71 - 1));
  assigns x69[0 .. x70*x71-1];
*/
void add(int *x63, int x64, int x65,
         int *x66, int x67, int x68,
         int *x69, int x70, int x71) {
...
/*@
  requires \valid_read(x111 + (0 .. x112*x113 - 1));
  requires \valid(x114 + (0 .. x115*x116 - 1));
  assigns x114[0 .. x115*x116 - 1];
*/
void scalar_mult(int x110, int *x111, int x112, int x113,
                 int *x114, int x115, int x116) {
